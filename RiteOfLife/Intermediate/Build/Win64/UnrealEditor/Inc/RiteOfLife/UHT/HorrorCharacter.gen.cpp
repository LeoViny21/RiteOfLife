...
RITEOFLIFE_API UClass* Z_Construct_UClass_AHorrorCharacter();
RITEOFLIFE_API UClass* Z_Construct_UClass_AHorrorCharacter_NoRegister();
...
struct Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics
{
	struct _Script_RiteOfLife_eventUpdateSprintMeterDelegate_Parms
	{
		float Percentage;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage = { "Percentage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RiteOfLife_eventUpdateSprintMeterDelegate_Parms, Percentage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::NewProp_Percentage,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RiteOfLife, nullptr, "UpdateSprintMeterDelegate__DelegateSignature", Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_RiteOfLife_eventUpdateSprintMeterDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::_Script_RiteOfLife_eventUpdateSprintMeterDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RiteOfLife_UpdateSprintMeterDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FUpdateSprintMeterDelegate_DelegateWrapper(const FMulticastScriptDelegate& UpdateSprintMeterDelegate, float Percentage)
{
	...
	_Script_RiteOfLife_eventUpdateSprintMeterDelegate_Parms Parms;
...
struct Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics
{
	struct _Script_RiteOfLife_eventSprintStateChangedDelegate_Parms
	{
		bool bSprinting;
	};
#if WITH_METADATA
...
void Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit(void* Obj)
{
	((_Script_RiteOfLife_eventSprintStateChangedDelegate_Parms*)Obj)->bSprinting = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting = { "bSprinting", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_RiteOfLife_eventSprintStateChangedDelegate_Parms), &Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::NewProp_bSprinting,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RiteOfLife, nullptr, "SprintStateChangedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_RiteOfLife_eventSprintStateChangedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::_Script_RiteOfLife_eventSprintStateChangedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RiteOfLife_SprintStateChangedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FSprintStateChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& SprintStateChangedDelegate, bool bSprinting)
{
	...
	_Script_RiteOfLife_eventSprintStateChangedDelegate_Parms Parms;
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AHorrorCharacter_DoEndSprint_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AHorrorCharacter, nullptr, "DoEndSprint", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AHorrorCharacter_DoEndSprint_Statics::Function_MetaDataParams), Z_Construct_UFunction_AHorrorCharacter_DoEndSprint_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AHorrorCharacter_DoStartSprint_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AHorrorCharacter, nullptr, "DoStartSprint", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AHorrorCharacter_DoStartSprint_Statics::Function_MetaDataParams), Z_Construct_UFunction_AHorrorCharacter_DoStartSprint_Statics::Function_MetaDataParams)},  };
...
void AHorrorCharacter::StaticRegisterNativesAHorrorCharacter()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "DoEndSprint", &AHorrorCharacter::execDoEndSprint },
		{ "DoStartSprint", &AHorrorCharacter::execDoStartSprint },
	};
...
struct Z_Construct_UClass_AHorrorCharacter_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AHorrorCharacter_DoEndSprint, "DoEndSprint" }, // 476218815
		{ &Z_Construct_UFunction_AHorrorCharacter_DoStartSprint, "DoStartSprint" }, // 1770798080
	};
...
UObject* (*const Z_Construct_UClass_AHorrorCharacter_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_ARiteOfLifeCharacter,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Horror_HorrorCharacter_h__Script_RiteOfLife_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AHorrorCharacter, AHorrorCharacter::StaticClass, TEXT("AHorrorCharacter"), &Z_Registration_Info_UClass_AHorrorCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AHorrorCharacter), 40856441U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Horror_HorrorCharacter_h__Script_RiteOfLife_890049508(TEXT("/Script/RiteOfLife"),
	Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Horror_HorrorCharacter_h__Script_RiteOfLife_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Horror_HorrorCharacter_h__Script_RiteOfLife_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
