...
RITEOFLIFE_API UClass* Z_Construct_UClass_UShooterUI();
RITEOFLIFE_API UClass* Z_Construct_UClass_UShooterUI_NoRegister();
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UShooterUI_BP_UpdateScore_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UShooterUI, nullptr, "BP_UpdateScore", Z_Construct_UFunction_UShooterUI_BP_UpdateScore_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UShooterUI_BP_UpdateScore_Statics::PropPointers), sizeof(ShooterUI_eventBP_UpdateScore_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UShooterUI_BP_UpdateScore_Statics::Function_MetaDataParams), Z_Construct_UFunction_UShooterUI_BP_UpdateScore_Statics::Function_MetaDataParams)},  };
...
struct Z_Construct_UClass_UShooterUI_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UShooterUI_BP_UpdateScore, "BP_UpdateScore" }, // 1456109203
	};
...
DEFINE_VTABLE_PTR_HELPER_CTOR(UShooterUI);
UShooterUI::~UShooterUI() {}
// ********** End Class UShooterUI *****************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Shooter_UI_ShooterUI_h__Script_RiteOfLife_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UShooterUI, UShooterUI::StaticClass, TEXT("UShooterUI"), &Z_Registration_Info_UClass_UShooterUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UShooterUI), 1986005330U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Shooter_UI_ShooterUI_h__Script_RiteOfLife_3502907329(TEXT("/Script/RiteOfLife"),
	Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Shooter_UI_ShooterUI_h__Script_RiteOfLife_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RiteOfLife_Source_RiteOfLife_Variant_Shooter_UI_ShooterUI_h__Script_RiteOfLife_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
